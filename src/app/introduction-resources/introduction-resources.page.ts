...
@Component({
  selector: 'app-introduction-resources',
  templateUrl: './introduction-resources.page.html',
  styleUrls: ['./introduction-resources.page.scss'],
})
export class IntroductionResourcesPage implements OnInit {
